...
<? foreach($data as $key => $value) {?>
    <div class="row">
        <div class="form-group form-inline prices-parent">
            ...
            <div class="col-xs-4"> <input  type="number" required="required"  class="form-control col-sm-2 prices"  data-sector_id="<?=$value['sector_id']?>" placeholder="Цена" value="<?=$value['sector_price']?>"  disabled="disabled" required="required"></div>
